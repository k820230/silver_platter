...
| 단계 | 목적 | 다음 단계 조건 |
| --- | --- | --- |
| G1 문서/설계 완료 | 요구사항과 설계 기준 확정 | 미결정 항목 목록화 |
...
| --- | --- |
| 국내+미국 동시 지원 범위 정의 | [ ] |
| 한국투자증권 Open API 초기 broker 확정 | [ ] |
| 별도 해외 broker 제외 반영 | [ ] |
| Goldilocks 기준 DB 반영 | [ ] |
| 자동 주문 최대 1,000,000,000원 반영 | [ ] |
| 단일 종목 투자금액 100,000원~1,000,000,000원 반영 | [ ] |
| 저유동성 3배 슬리피지 반영 | [ ] |
| FIFO 모든 계좌 강제 반영 | [ ] |
| 백업 매주 토요일 10:00 KST 반영 | [ ] |
| 세금 리포트 보조 성격 표시 | [ ] |
...
| 항목 | 상태 |
| --- | --- |
| 종목별/섹터별/통화별/일일손실/MDD 리스크 한도 숫자 | [ ] |
| 그룹별 최대 비중/최대 손실/유동성 한도 | [ ] |
| 변동성/위험도 지수 산식 범위 | [ ] |
| 테스트 모드 기본 초기 자산/체결 지연/부분체결 정책 | [ ] |
| 공시 영향 분석 MVP source/taxonomy/window | [ ] |
| 환율 source 우선순위 | [ ] |
| 외부 모바일 접속 방식 | [ ] |
...
| --- | --- |
| 사용자 watchlist 생성 | [ ] |
| 1일/1주/1개월/3개월 horizon 작업 생성 | [ ] |
| 가격 예측 범위 저장 | [ ] |
| 거래량 예측 저장 | [ ] |
| 변동성 예측 저장 | [ ] |
| 위험도 예측 저장 | [ ] |
| 종목별 fine-tuning 적용/미적용 사유 저장 | [ ] |
| 모델 버전과 feature set 저장 | [ ] |
| 예측 실제값 매핑 | [ ] |
| 예측 오차 dashboard 표시 | [ ] |
...
| 항목 | 확인 |
| --- | --- |
| 단일 종목 투자금액 hard gate | [ ] |
| 자동 주문 1건 최대 금액 hard gate | [ ] |
| 저유동성 3배 슬리피지 | [ ] |
| 사업 그룹 노출 계산 | [ ] |
| 통화별 노출 계산 | [ ] |
| 변동성 지수 산출 | [ ] |
| 위험도 지수 0~100 산출 | [ ] |
| 공시/헤드라인/국제 이벤트 risk signal | [ ] |
...
| 주문 가능 시간 확인 | [ ] |
| simulation 주문 broker 미전송 | [ ] |
| paper/live 모드 명확히 분리 | [ ] |
| 주문 이벤트 감사 로그 | [ ] |
| broker 잔고 대사 | [ ] |
...
| 항목 | 확인 |
| --- | --- |
| live/paper/simulation 전역 표시 | [ ] |
| 주문창 예측 가격 범위 표시 | [ ] |
| 예측 데이터 오류 표시 | [ ] |
| 종목별 ML 탭 표시 | [ ] |
| 변동성/위험도 지수 차트 | [ ] |
| 그룹 변동성 비교 그래프 | [ ] |
| 국제 정세 급변 배너/toast/패널 | [ ] |
| FIFO 매매 기록 화면 | [ ] |
| 해외 세금 화면 | [ ] |
| 모바일 핵심 화면 | [ ] |
...
| 운영 승인 | audit log |
| 미결정 해소 | 요구사항 문서 revision |

## 18. 산출물 완료 기준

본 문서까지 작성되면 요구사항 정의서의 `다음 산출물 제안` 목록 기준으로 14번 이후 남은 산출물은 모두 생성된 상태다.

후속 작업은 문서 미결정 사항 확정, 구현 backlog 분해, 개발 환경 bootstrap, schema migration 작성 순서로 진행한다.
