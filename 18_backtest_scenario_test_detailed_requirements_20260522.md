...
리스크 한도 숫자가 확정되지 않은 항목은 scenario parameter로 실험할 수 있어야 한다.
...
1. 기본 초기 자산
2. 부분체결 거래량 제한 비율
3. 수수료/세금 기본 rule version
4. simulation replay 데이터 제공 범위
5. scenario 충격값의 운영 기본값
6. 백테스트 결과 보존 기간
